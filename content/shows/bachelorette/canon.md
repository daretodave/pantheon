...
weekly_question: Which Bachelorette season holds up best on rewatch in 2026?
era_bands:
  - key: founding
    label: Founding
    range: [2003, 2007]
...
## 13. Rachel Lindsay
tag: The franchise's most overdue first, handled with the storytelling weight it deserved.
slot_argument: First Black lead in fifteen years of the show; major-argument season that finally said something the franchise had needed to say.
...
## 15. Hannah Brown
tag: The modern franchise peak. A magnetic lead and the longest book the show had built.
...
slot_argument: Modern peak with a structural first — two leads decided by a contestant vote — plus one of the sharpest leads of the run.
...
## 6. Ali Fedotowsky
tag: The modern Bachelorette template, fully assembled and finally confident.
slot_argument: The season the travelogue stops apologizing and starts arguing; production scale plus editorial pitch carry it into the top tier.
...
## 1. Trista Rehn
tag: The flip works. Foundational document, six tight episodes, the franchise doubles in one move.
slot_argument: Format-defining weight; the proof that a woman holding the roses could carry a show belongs near the top of any honest canon.
...
## 8. Emily Maynard
tag: The franchise leaves the mansion, builds a season around a real life, and clears the bar.
...
slot_argument: A well-built modern travelogue that knows exactly what it is; sits high on the run for craft rather than innovation.
...
## 5. Jillian Harris
tag: The passport opens. Canadian lead, expanded cast, the format finally goes overseas.
slot_argument: First international travel run plus the first non-American lead — the season the show's later scale starts being possible.
